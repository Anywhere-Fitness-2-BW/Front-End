...
import InstructorClassList from "./components/Protected/Instructor/InstructorClassList";
  ...
  return (
    <div className="App">
      <ClassListContext.Provider value={{ classList, setClassList }}>
        <Router>
          <NavContext.Provider
            value={{ isLoggedIn, setIsLoggedIn, isClient, setIsClient }}
          >
            <Navigation />
            <Route path="/login">
              <Logo />
